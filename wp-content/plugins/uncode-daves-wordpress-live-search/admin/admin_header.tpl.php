...
<?php if( $wp_pre_4_3 ) : ?><h2><?php else : ?><h1><?php endif; ?>
	<?php _e( "Dave's WordPress Live Search Options", 'daves-wordpress-live-search' ); ?>
<?php if( $wp_pre_4_3 ) : ?></h2><?php else : ?></h1><?php endif; ?>
<ul class="subsubsub">
<?php
...
<li class="<?php echo $tab_param; ?>">
	<a href="<?php echo add_query_arg( 'tab', $tab_param, $_SERVER['REQUEST_URI'] ); ?>" class=" <?php if( $current_tab === $tab_param ) : ?>current<?php endif; ?>"><?php _e( $tab_label, 'daves-wordpress-live-search' ); ?></a><?php if( $tab_param !== $last_tab_param ) : ?> |<?php endif; ?>
</li>
<?php endforeach; ?>
</ul>
