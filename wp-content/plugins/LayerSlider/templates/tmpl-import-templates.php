	...
	<div id="ls-import-modal-window" class="ls-box <?php echo $lsStoreHasUpdate ? 'has-updates' : '' ?>">
		<header class="header">
			...
			<div class="last-update">
				...
				<a title="<?php _e('Force Library Update', 'LayerSlider') ?>"href="<?php echo wp_nonce_url('?page=layerslider&action=update_store', 'update_store') ?>" class="refresh-btn fas fa-sync-alt"></a>
			</div>
