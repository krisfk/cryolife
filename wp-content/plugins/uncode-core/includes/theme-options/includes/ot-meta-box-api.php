            ...
            echo '<div class="format-setting-wrap">';
              ...
              if ( $_args['type'] != 'textblock' && ! empty( $field['label'] ) ) {
                echo '<div class="format-setting-label">';
	                ...
	                echo '</label>';
			    	if ( isset($field['desc']) && $field['desc'] !== '' ) echo '<small class="description">' . htmlspecialchars_decode( $field['desc'] ) . '</small>';
                echo '</div>';
              }
      ...
      foreach ( $this->meta_box['fields'] as $field ) {
        ...
        if ( isset($field['id']) && isset( $_POST[$field['id']] ) ) {
          ...
          if ( in_array( $field['type'], array( 'list-item', 'slider' ) ) ) {
            ...
            $settings = isset( $_POST[$field['id'] . '_settings_array'] ) ? uncode_core_safe_unserialize( ot_decode( $_POST[$field['id'] . '_settings_array'] ) ) : array();
