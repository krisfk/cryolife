		...
		get_style_value: function() {
			...
			if (len === 1) {
				...
				if (this.type == 'linear') {
					...
					style_str = "to " + linear_dir + " , " + style_str; //add direction for gradient
				} else {
					//position, type size, [color stoppers]
					//style_str = this.direction + " , " + this.type + " " + this.shape + " , " + style_str;
					style_str = this.type + " at " + this.direction + " , " + style_str;
				}
