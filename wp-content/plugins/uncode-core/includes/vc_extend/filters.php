...
function uncode_js_composer_toString_tags_array( $tags ) {
		...
		$tags_array = array( 'vc_accordion', 'vc_raw_html', 'vc_raw_js', 'vc_flickr', 'vc_section', 'uncode_twentytwenty', 'vc_gutenberg', 'product', 'add_to_cart', 'add_to_cart_url', 'product_page', 'rev_slider' );
...
function uncode_js_composer_renderShortcodes_tags_array( $tags ) {
		...
		$tags_array = array( 'vc_accordion', 'vc_raw_html', 'vc_raw_js', 'vc_flickr', 'vc_section', 'contact-form-7', 'uncode_twentytwenty', 'vc_gutenberg', 'product', 'add_to_cart', 'add_to_cart_url', 'product_page', 'rev_slider' );
		$tags = array_merge($tags, $tags_array);
		return $tags;
...
/**
 * Add CF7 edit link in CF7 module.
 */
