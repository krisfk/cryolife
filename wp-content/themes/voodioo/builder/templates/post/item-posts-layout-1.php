...
<div class="<?php echo tm_builder_tools()->get_col_classes( $this ); ?>">
	<div class="tm-posts_item">
		...
		<div class="tm-posts_item_content_wrap">
			...
			tm_builder_core()->utility()->attributes->get_title( apply_filters( 'voodioo_module_post_title_settings_layout_1', array(
					'visible'      => true,
					'trimmed_type' => 'word',
					'ending'       => '&hellip;',
			...
			tm_builder_core()->utility()->attributes->get_button( apply_filters( 'voodioo_module_post_btn_settings_layout_1', array(
					'visible' => true,
			...
			?>
			<div class="tm-posts_item_content_footer">
				<?php
				...
				tm_builder_core()->utility()->meta_data->get_terms( array(
						...
						'before' => '<div class="post__cats post_tags">',
						'after'  => '</div>',
						'echo'   => true,
				) );
