...
<form class="tm_pb_contact_form clearfix" method="post" action="<?php echo esc_url( get_permalink( get_the_ID() ) ); ?>">
	<div class="voodioopb-contact-message"><?php echo $this->_var( 'tm_error_message' ); ?></div>
	<div class="row">
	...
	<?php wp_nonce_field( 'voodioopb-contact-form-submit', '_wpnonce-voodioopb-contact-form-submitted', true, true ); ?>
</form>
