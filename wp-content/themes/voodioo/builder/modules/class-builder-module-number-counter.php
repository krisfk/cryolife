<?php
/**
 * class Voodioo_Builder_Module_Number_Counter.
 */
class Voodioo_Builder_Module_Number_Counter extends Tm_Builder_Module {

	public $function_name;

	public function init() {
		$this->name = esc_html__( 'Number Counter', 'voodioo' );
		...
		$this->custom_css_options = array(
			'percent' => array(
				'label'    => esc_html__( 'Percent', 'voodioo' ),
				'selector' => '.percent',
			),
			'number_counter_title' => array(
				'label'    => esc_html__( 'Number Counter Title', 'voodioo' ),
				'selector' => 'h3',
			),
		);
		...
		$this->advanced_options = array(
			'fonts' => array(
				...
				'number'   => array(
					'label'    => esc_html__( 'Number', 'voodioo' ),
					'css'      => array(
	...
	public function get_fields() {
		$fields = array(
			'title' => array(
				...
				'description'     => esc_html__( 'Input a title for the counter.', 'voodioo' ),
			),
			'number' => array(
				'label'           => esc_html__( 'Number', 'voodioo' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( "Define a number for the counter. (Don't include the percentage sign, use the option below.)", 'voodioo' ),
			),
			'percent_sign' => array(
				'label'           => esc_html__( 'Percent Sign', 'voodioo' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'on'  => esc_html__( 'On', 'voodioo' ),
					'off' => esc_html__( 'Off', 'voodioo' ),
				),
				'description'     => esc_html__( 'Here you can choose whether the percent sign should be added after the number set above.', 'voodioo' ),
			),
			'counter_color' => array(
				'label'       => esc_html__( 'Counter Text Color', 'voodioo' ),
				'type'        => 'color',
				'description' => esc_html__( 'This will change the fill color for the bar.', 'voodioo' ),
			),
			'use_icon' => array(
				'label'           => esc_html__( 'Use Icon', 'voodioo' ),
				'type'            => 'yes_no_button',
				'option_category' => 'basic_option',
				'options'         => array(
				...
				'description'     => esc_html__( 'Here you can choose whether icon set below should be used.', 'voodioo' ),
			),
			'font_icon' => array(
...
new Voodioo_Builder_Module_Number_Counter;
