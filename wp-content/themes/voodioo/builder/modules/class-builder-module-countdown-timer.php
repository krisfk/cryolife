...
/**
 * class Voodioo_Builder_Module_Countdown_Timer.
 */
class Voodioo_Builder_Module_Countdown_Timer extends Tm_Builder_Module {

	public $function_name;

	public function init() {
		$this->name = esc_html__( 'Countdown Timer', 'voodioo' );
		...
		$this->advanced_options = array(
			'fonts' => array(
				'header' => array(
					'label'    => esc_html__( 'Header', 'voodioo' ),
					'css'      => array(
						'main' => "{$this->main_css_element} h4",
					),
				),
				'numbers' => array(
					'label'    => esc_html__( 'Numbers', 'voodioo' ),
					'css'      => array(
				...
				'label' => array(
					'label'    => esc_html__( 'Label', 'voodioo' ),
					'css'      => array(
		...
		$this->custom_css_options = array(
			'container' => array(
				'label'    => esc_html__( 'Container', 'voodioo' ),
			...
			'timer_section' => array(
				'label'    => esc_html__( 'Timer Section', 'voodioo' ),
				'selector' => '.section',
			),
		);
	}
	...
	public function get_fields() {
		$fields = array(
			'title' => array(
				'label'           => esc_html__( 'Countdown Timer Title', 'voodioo' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'This is the title displayed for the countdown timer.', 'voodioo' ),
			),
			'date_time' => array(
				'label'           => esc_html__( 'Countdown To', 'voodioo' ),
				'type'            => 'date_picker',
				'option_category' => 'basic_option',
				'description'     => tm_get_safe_localization(
					sprintf(
						...
						esc_html__( 'This is the date the countdown timer is counting down to. Your countdown timer is based on your timezone settings in your ', 'voodioo' ),
						esc_html__( 'WordPress General Settings', 'voodioo' )
					)
				),
			),
			'use_background_color' => array(
				'label'           => esc_html__( 'Use Background Color', 'voodioo' ),
				'type'            => 'yes_no_button',
				...
				'description' => esc_html__( 'Here you can choose whether background color setting below should be used or not.', 'voodioo' ),
			),
			'background_color' => array(
				'label'             => esc_html__( 'Background Color', 'voodioo' ),
				'type'              => 'color-alpha',
				'depends_default'   => true,
				'description'       => esc_html__( 'Here you can define a custom background color for your countdown timer.', 'voodioo' ),
			),
			'timer_layout' => array(
				'label'             => esc_html__( 'Layout', 'voodioo' ),
				'type'              => 'select',
				'options'           => array(
					'flat'   => esc_html__( 'Flat', 'voodioo' ),
					'circle' => esc_html__( 'Circle', 'voodioo' ),
				),
				'affects'           => array(
			...
			'circle_background' => array(
				'label'               => esc_html__( 'Circle Background Color', 'voodioo' ),
				'type'                => 'color-alpha',
			...
			'use_circle_border' => array(
				'label'           => esc_html__( 'Use Circle Border', 'voodioo' ),
				'type'            => 'yes_no_button',
	...
	public function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$classes[] = sprintf( 'tm_pb_countdown_timer_%s_layout', sanitize_html_class( $this->_var( 'timer_layout' ) ) );
		$atts      = array(
...
new Voodioo_Builder_Module_Countdown_Timer;
