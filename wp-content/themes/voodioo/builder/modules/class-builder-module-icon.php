 ...
 */
class Voodioo_Builder_Module_Icon extends Tm_Builder_Module {

	public $function_name;

	public function init() {
		$this->name = esc_html__( 'Icon', 'voodioo' );
		$this->icon = 'f1d8';
	...
	public function get_fields() {
		...
		$fields = array(
			'font_icon' => array(
				'label'               => esc_html__( 'Icon', 'voodioo' ),
				'type'                => 'text',
				'option_category'     => 'basic_option',
				'class'               => array( 'Voodioopb-font-icon' ),
				'renderer'            => 'tm_pb_get_font_icon_list',
				'renderer_with_field' => true,
				'description'         => esc_html__( 'Choose an icon to display.', 'voodioo' ),
			),
			'icon_color' => array(
				'label'       => esc_html__( 'Icon Color', 'voodioo' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for your icon.', 'voodioo' ),
			),
			'use_circle' => array(
				'label'           => esc_html__( 'Circle Icon', 'voodioo' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'off' => esc_html__( 'No', 'voodioo' ),
					'on'  => esc_html__( 'Yes', 'voodioo' ),
				),
				'affects'         => array(
				...
				'description'     => esc_html__( 'Here you can choose whether icon set above should display within a circle.', 'voodioo' ),
			),
			'circle_color' => array(
				'label'       => esc_html__( 'Circle Color', 'voodioo' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for the icon circle.', 'voodioo' ),
			),
			'use_circle_border' => array(
				'label'           => esc_html__( 'Show Circle Border', 'voodioo' ),
				'type'            => 'yes_no_button',
				...
				'description'     => esc_html__( 'Here you can choose whether if the icon circle border should display.', 'voodioo' ),
			),
			'circle_border_color' => array(
				'label'       => esc_html__( 'Circle Border Color', 'voodioo' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for the icon circle border.', 'voodioo' ),
			),
			'animation' => array(
				'label'           => esc_html__( 'Icon Animation', 'voodioo' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'options'         => array(
					'top'    => esc_html__( 'Top To Bottom', 'voodioo' ),
					'left'   => esc_html__( 'Left To Right', 'voodioo' ),
					'right'  => esc_html__( 'Right To Left', 'voodioo' ),
					'bottom' => esc_html__( 'Bottom To Top', 'voodioo' ),
					'off'    => esc_html__( 'No Animation', 'voodioo' ),
				),
				'description'     => esc_html__( 'This controls the direction of the lazy-loading animation.', 'voodioo' ),
			),
			'icon_orientation' => array(
				'label'           => esc_html__( 'Icon Orientation', 'voodioo' ),
				'type'            => 'select',
				'option_category' => 'layout',
				'options'         => array(
				...
				'description'     => esc_html__( 'This will control how your icon is aligned.', 'voodioo' ),
			),
			'use_icon_font_size' => array(
				'label'           => esc_html__( 'Use Icon Font Size', 'voodioo' ),
				'type'            => 'yes_no_button',
			...
			'icon_font_size' => array(
				'label'           => esc_html__( 'Icon Font Size', 'voodioo' ),
				'type'            => 'range',
				'option_category' => 'font_option',
				'tab_slug'        => 'advanced',
				'default'         => '50px',
			...
			'circle_size' => array(
				'label'           => esc_html__( 'Circle Size', 'voodioo' ),
				'type'            => 'range',
				'option_category' => 'layout',
				'tab_slug'        => 'advanced',
				'default'         => '100',
				...
				'description'     => esc_html__( 'Here you can define a custom diameter for the icon circle.', 'voodioo' ),
				'mobile_options'  => true,
				'depends_default' => true,
			),
			'circle_border_width' => array(
				'label'           => esc_html__( 'Circle Border Width', 'voodioo' ),
				'type'            => 'range',
				'option_category' => 'layout',
				'tab_slug'        => 'advanced',
				'default'         => '2',
				...
				'description'     => esc_html__( 'Here you can define a custom width for the icon circle border.', 'voodioo' ),
				'depends_default' => true,
			),
			...
			'disabled_on' => array(
				'label'           => esc_html__( 'Disable on', 'voodioo' ),
				'type'            => 'multiple_checkboxes',
				'options'         => tm_pb_media_breakpoints(),
				'additional_att'  => 'disable_on',
				'option_category' => 'configuration',
				'description'     => esc_html__( 'This will disable the module on selected devices', 'voodioo' ),
			),
			'admin_label' => array(
				'label'       => esc_html__( 'Admin Label', 'voodioo' ),
				'type'        => 'text',
				'description' => esc_html__( 'This will change the label of the module in the builder for easy identification.', 'voodioo' ),
			),
			'module_id' => array(
				'label'           => esc_html__( 'CSS ID', 'voodioo' ),
				'type'            => 'text',
				'option_category' => 'configuration',
				'tab_slug'        => 'custom_css',
			...
			'module_class' => array(
				'label'           => esc_html__( 'CSS Class', 'voodioo' ),
				'type'            => 'text',
				'option_category' => 'configuration',
				'tab_slug'        => 'custom_css',
				'option_class'    => 'tm_pb_custom_css_regular',
	...
	public function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		if ( '' !== $this->_var( 'font_icon' ) ) {
			...
			$content = sprintf(
				'<span class="tm-pb-icon voodioowaypoint%2$s%3$s%4$s" style="%5$s" data-icon="%1$s"></span>',
				$icon,
...
new Voodioo_Builder_Module_Icon;
