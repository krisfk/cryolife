...
if ( ! class_exists( 'Voodioo_Widget_Area' ) ) {

	/**
	 * class Voodioo_Widget_Area.
	 */
	class Voodioo_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'voodioo_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'voodioo_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'voodioo_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function voodioo_widget_area() {
		return Voodioo_Widget_Area::get_instance();
	}
