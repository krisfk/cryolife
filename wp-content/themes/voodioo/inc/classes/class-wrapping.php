 ...
 */
add_filter( 'template_include', array( 'Voodioo_Wrapping', 'wrap' ), 99 );
add_filter( 'voodioo_wrap_base', 'voodioo_wrap_base_cpts' );
 ...
 */
function voodioo_template_path() {
	return Voodioo_Wrapping::$main_template;
}
 ...
 */
function voodioo_template_base() {
	return Voodioo_Wrapping::$base;
}

if ( ! class_exists( 'Voodioo_Wrapping' ) ) {
	...
	class Voodioo_Wrapping {
		...
		/**
		 * Initialize new instance of Voodioo_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'voodioo_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Voodioo_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function voodioo_wrap_base_cpts( $templates ) {
