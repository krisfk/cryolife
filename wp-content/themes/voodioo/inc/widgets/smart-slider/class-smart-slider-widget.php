...
if ( ! class_exists( 'Voodioo_Smart_Slider_Widget' ) ) {

	/**
	 * Class Voodioo_Smart_Slider_Widget.
	 */
	class Voodioo_Smart_Slider_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display smart slider on your site.', 'voodioo' );
			$this->widget_id          = 'voodioo_widget_smart_slider';
			$this->widget_name        = esc_html__( 'Smart Slider', 'voodioo' );
			...
			$this->settings           = array(
				...
				'tags' => array(
					...
					'options'          => false,
					'label'            => esc_html__( 'Select tags', 'voodioo' ),
					'multiple'         => true,
				...
				'post_title' => array(
					...
					'label' => esc_html__( 'Display title', 'voodioo' ),
				),
				'content' => array(
					'type'  => 'switcher',
					'value' => 'false',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Display content', 'voodioo' ),
				),
				'more_button' => array(
					'type'   => 'switcher',
					'value'  => 'true',
				...
				'title_trim_words' => array(
					...
					'min_value'  => 1,
					'step_value' => 1,
					'label'      => esc_html__( 'Title words trimmed count', 'voodioo' ),
				),
				'trim_words' => array(
					'type'       => 'slider',
					'value'      => 15,
				...
				'width' => array(
					'type'  => 'text',
					'value' => '100%',
					'label' => esc_html__( 'Slider width', 'voodioo' ),
				),
				'height' => array(
					'type'  => 'text',
					'value' => '800',
					'label' => esc_html__( 'Slider height', 'voodioo' ),
				),
				'orientation' => array(
					'type'    => 'select',
					'size'    => 1,
					'value'   => 'horizontal',
					'options' => array(
						'horizontal' => esc_html__( 'Horizontal', 'voodioo' ),
						'vertical'   => esc_html__( 'Vertical', 'voodioo' ),
					),
					'label'   => esc_html__( 'Slider orientation', 'voodioo' ),
				),
				'slide_distance' => array(
					...
					'max_value' => 100,
					'min_value' => 0,
					'label'     => esc_html__( 'Slide distance(px)', 'voodioo' ),
				),
				'slide_duration' => array(
					...
					'min_value'  => 100,
					'step_value' => 100,
					'label'      => esc_html__( 'Slide duration(ms)', 'voodioo' ),
				),
				'slide_fade' => array(
					'type'  => 'switcher',
					'value' => 'false',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Use fade effect?', 'voodioo' ),
				),
				'navigation' => array(
					'type'   => 'switcher',
					'value'  => 'true',
					'style'  => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'  => esc_html__( 'Use navigation?', 'voodioo' ),
					'toggle' => array(
						'true_toggle'  => esc_html__( 'On', 'voodioo' ),
						'false_toggle' => esc_html__( 'Off', 'voodioo' ),
				...
				'fade_navigation' => array(
					...
					'value'  => 'true',
					'style'  => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'  => esc_html__( 'Indicates whether the arrows will fade in only on hover', 'voodioo' ),
				...
				'pagination' => array(
					...
					'value' => 'true',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Use pagination?', 'voodioo' ),
				),
				'autoplay' => array(
					'type'  => 'switcher',
					'value' => 'true',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Use autoplay?', 'voodioo' ),
				),
				'fullScreen' => array(
					'type'  => 'switcher',
					'value' => 'false',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Display fullScreen button?', 'voodioo' ),
				),
				'shuffle' => array(
					'type'  => 'switcher',
					'value' => 'false',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Indicates if the slides will be shuffled', 'voodioo' ),
				),
				'loop' => array(
					'type'  => 'switcher',
					'value' => 'true',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Use infinite scrolling?', 'voodioo' ),
				),
				'thumbnails' => array(
					'type'   => 'switcher',
					'value'  => 'false',
					'style'  => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'  => esc_html__( 'Display thumbnails?', 'voodioo' ),
					'toggle' => array(
						'true_toggle'  => esc_html__( 'On', 'voodioo' ),
						'false_toggle' => esc_html__( 'Off', 'voodioo' ),
				...
				'thumbnails_position' => array(
					...
					'options' => array(
						...
						'bottom' => esc_html__( 'Bottom', 'voodioo' ),
						'right'  => esc_html__( 'Right', 'voodioo' ),
						'left'   => esc_html__( 'Left', 'voodioo' ),
					),
					'label'   => esc_html__( 'Sets the position of the thumbnail scroller', 'voodioo' ),
				...
				'thumbnails_arrows' => array(
					...
					'value'  => 'true',
					'style'  => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'  => esc_html__( 'Display thumbnails arrows?', 'voodioo' ),
					'master' => 'thumbnails_attr',
				),
			);
		...
		public function widget( $args, $instance ) {
			...
			if ( $posts_query ) {
				...
				$html = '<h4>' . esc_html__( 'Posts for slider not found', 'voodioo' ) . '</h4>';
			}
		...
		public function render_slider( $posts_query ) {
			...
			$html = '<div class="voodioo-smartslider smart-slider__instance invert" ' . $slider_html_attr . '>';
		...
		public function get_query_slider_items( $query_args = array() ) {
			...
			$defaults_query_args = apply_filters( 'voodioo_smart_slider_default_query_args', array(
				'post_type'           => 'post',
				'orderby'             => 'date',
				'order'               => 'DESC',
				'posts_per_page'      => - 1,
		...
		public function get_slider_loop( $posts_query ) {
			 ...
			 * @var  array
			 */
			$title_settings = apply_filters( 'voodioo_smart_slider_title_settings', array(
				'width'           => '100%%',
				'horizontal'      => '0%%',
				'vertical'        => '38%%',
			 ...
			 * @var  array
			 */
			$content_settings = apply_filters( 'voodioo_smart_slider_content_settings', array(
				'width'           => '100%%',
				'horizontal'      => '0%%',
				'vertical'        => '51%%',
				'show_transition' => 'left',
			 ...
			 * @var  array
			 */
			$more_settings = apply_filters( 'voodioo_smart_slider_more_button_settings', array(
				'width'           => '100%%',
				'horizontal'      => '0%%',
				'vertical'        => '58%%',
				'show_transition' => 'left',
			...
			while ( $posts_query->have_posts() ) : $posts_query->the_post();
				...
				$html .= '<div class="smart-slider__item sp-slide">';
					$html .= $this->utility->media->get_image( array(
						'size'        => 'voodioo-thumb-xl',
						'mobile_size' => 'voodioo-thumb-l',
						'class'       => 'sp-image',
						'html'        => '<img %2$s src="%3$s" alt="%4$s" %5$s >',
					) );

					$html .= '<div class="sp-content-container container">';
		...
		public function get_slider_thumbnails( $posts_query ) {
			...
			while ( $posts_query->have_posts() ) : $posts_query->the_post();
				$html .= '<div class="sp-thumbnail">';
					$html .= $this->utility->media->get_image( array(
						'size'        => 'voodioo-slider-thumb',
						'mobile_size' => 'voodioo-slider-thumb',
	...
	add_action( 'widgets_init', 'voodioo_register_smart_slider_widgets' );
	/**
	 * Register Smart slider widget.
	 */
	function voodioo_register_smart_slider_widgets() {
		register_widget( 'Voodioo_Smart_Slider_Widget' );
	}
}
