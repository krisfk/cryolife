...
if ( ! class_exists( 'Voodioo_Banner_Widget' ) ) {

	/**
	 * Class Voodioo_Banner_Widget.
	 */
	class Voodioo_Banner_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display a banner in your sidebar.', 'voodioo' );
			$this->widget_id          = 'voodioo_widget_banner';
			$this->widget_name        = esc_html__( 'Banner', 'voodioo' );
			$this->settings           = array(
				'title'  => array(
					'type'  => 'text',
					'value' => '',
				...
				'media_id' => array(
					...
					'value'              => '',
					'label'              => esc_html__( 'Source:', 'voodioo' ),
				),
				'media_size' => array(
					'type'             => 'select',
					'value'            => 'full',
					...
					'options'          => false,
					'label'            => esc_html__( 'Select image size', 'voodioo' ),
					'placeholder'      => esc_html__( 'Select image size', 'voodioo' ),
				),
				'link' => array(
					'type'        => 'text',
					'placeholder' => esc_html__( 'Type a banner`s link', 'voodioo' ),
					'value'       => esc_url( home_url( '/' ) ),
					'label'       => esc_html__( 'Link:', 'voodioo' ),
				),
				'target' => array(
					'type'    => 'select',
					'options' => array(
						'_blank' => esc_html__( 'A new window or tab', 'voodioo' ),
						'_self'  => esc_html__( 'The same frame as it was clicked', 'voodioo' ),
					),
					'value' => '_blank',
					'label' => esc_html__( 'Opens in:', 'voodioo' ),
				),
			);
		...
		public function get_image_sizes() {
			...
			$result = array_merge( $result, array( 'full' => esc_html__( 'Full', 'voodioo' ) ) );
...
add_action( 'widgets_init', 'voodioo_register_banner_widget' );
/**
 * Register banner widget.
 */
function voodioo_register_banner_widget() {
	register_widget( 'Voodioo_Banner_Widget' );
}
