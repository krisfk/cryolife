...
if ( ! class_exists( 'Voodioo_Playlist_Slider_Widget' ) ) {

	/**
	 * Class Voodioo_Playlist_Slider_Widget.
	 */
	class Voodioo_Playlist_Slider_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			$this->widget_name        = esc_html__( 'Playlist Slider', 'voodioo' );
			$this->widget_description = esc_html__( 'Display playlist slider on your site.', 'voodioo' );
			$this->widget_id          = apply_filters( 'voodioo_playlist_slider_widget_ID', 'voodioo_widget_playlist_slider' );
			$this->widget_cssclass    = apply_filters( 'voodioo_playlist_slider_widget_cssclass', 'widget-playlist-slider' );
			$this->utility            = voodioo_utility()->utility;
			$this->settings = array(
				'title' => array(
					'type'  => 'text',
					'value' => esc_html__( 'Playlist Slider', 'voodioo' ),
				...
				'posts_per_page' => array(
					...
					'max_value' => 50,
					'min_value' => 0,
					'label'     => esc_html__( 'Posts count ( Set 0 to show all. )', 'voodioo' ),
				),
				'width' => array(
					'type'  => 'text',
					'value' => '100%',
					'label' => esc_html__( 'Slider width ( px, %, rem )', 'voodioo' ),
				),
				'height' => array(
					'type' => 'text',
					'value' => '525',
					'label' => esc_html__( 'Slider height ( px, rem )', 'voodioo' ),
				),
				'thumbnail_controls' => array(
					...
					'value'   => true,
					'options' => array(
						false => esc_html__( 'Hide', 'voodioo' ),
						true  => esc_html__( 'Buttons', 'voodioo' ),
					),
					'label'       => esc_html__( 'Select Thumbnail Controls', 'voodioo' ),
					'placeholder' => esc_html__( 'Select Thumbnail Controls', 'voodioo' ),
				),
				'slider_controls' => array(
					...
					'label'       => esc_html__( 'Select Slider Controls', 'voodioo' ),
					'placeholder' => esc_html__( 'Select Thumbnail Controls', 'voodioo' ),
				),
				'title_length' => array(
					'type'       => 'stepper',
					...
					'min_value'  => '0',
					'step_value' => '1',
					'label'      => esc_html__( 'Title words length ( Set 0 to hide title. )', 'voodioo' ),
				),
				'thumb_title_length' => array(
					...
					'min_value'  => '0',
					'step_value' => '1',
					'label'      => esc_html__( 'Thumbnail title words length ( Set 0 to hide title. )', 'voodioo' ),
				),
				'mate_data' => array(
					'type'  => 'checkbox',
					'value' => array(
					...
					'options' => array(
						'date'     => esc_html__( 'Date', 'voodioo' ),
						'author'   => esc_html__( 'Author', 'voodioo' ),
						'comments' => esc_html__( 'Comment count', 'voodioo' ),
						'category' => esc_html__( 'Category', 'voodioo' ),
						'post_tag' => esc_html__( 'Tag', 'voodioo' ),
					),
					'label' => esc_html__( 'Display post meta data', 'voodioo' ),
				),
				'thumb_mate_data' => array(
					...
					'label' => esc_html__( 'Display thumbnail post meta data', 'voodioo' ),
				),
			);
			...
			$this->layout_settings = apply_filters( 'voodioo_playlist_slider_size', array(
		...
		public function the_thumbnail_view() {
			...
			foreach ( $this->posts as $post ) {
				...
				$image = $this->utility->media->get_image( array(
					'size'              => 'voodioo-thumb-s',
					'mobile_size'       => 'voodioo-thumb-s',
		...
		public function widget( $args, $instance ) {
			...
			if ( $this->posts ) {
				$slider_settings = array(
					...
					'buttons'            => apply_filters( 'voodioo_playlist_buttons', false ),
...
add_action( 'widgets_init', 'voodioo_register_playlist_slider_widget' );
/**
 * Register playlist-slider widget.
 */
function voodioo_register_playlist_slider_widget() {
	register_widget( 'Voodioo_Playlist_Slider_Widget' );
}
