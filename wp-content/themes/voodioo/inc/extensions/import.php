...
add_filter( 'cherry_data_import_home_regex_replace', 'voodioo_remap_shortcodes' );
add_action( 'cherry_data_import_remap_posts',        'voodioo_remap_menus' );
add_action( 'cherry_data_import_remap_posts',        'voodioo_remap_timetable' );
 ...
 * @return array
 */
function voodioo_remap_shortcodes( $regex ) {
 ...
 */
function voodioo_remap_timetable( $posts ) {
 ...
 * @param array $posts post remapping array.
 */
function voodioo_remap_menus( $posts ) {
